...
const CadastroSucessoHotels: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('hotelData', JSON.stringify({
        nome,
        whatsapp,
        email,
        endereco,
      ...
      const response = await fetch(`${API_BASE}/api/register-hotels`, {
        method: 'POST',
        body: formData,
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center py-16 px-4">
        <div className="max-w-md w-full my-8 bg-white rounded-2xl shadow-sm p-8 text-center">
          ...
          <p className="text-gray-500 text-sm mb-8">
            Seus dados foram enviados com sucesso. Seu perfil de hotel está em análise e será aprovado em até 24 horas — você receberá um e-mail de confirmação.
          </p>
          <button onClick={() => navigate('/hoteis-em-aparecida-sp')} className="w-full bg-blue-600 text-white py-3.5 rounded-lg font-medium hover:bg-blue-700">
            Ver Página de Hotéis
          </button>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-16 px-4 page-container">
      <div className="max-w-xl w-full">
        <div className="bg-white rounded-2xl shadow-sm p-8">
          ...
          <p className="text-gray-500 text-sm mb-8">
            Pagamento confirmado! Agora preencha os dados que aparecerão na página do seu hotel.
          </p>

          <form onSubmit={handleSubmit} className="space-y-6" encType="multipart/form-data">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Fotos do Hotel (máx. 5) — deixe em branco para usar foto padrão
              </label>
              <input
                type="file"
                accept="image/*"
            ...
            <div>
              ...
              <input type="text" required value={nome} onChange={e => setNome(e.target.value)}
                ...
                placeholder="Ex: Hotel Aparecida Palace" />
            </div>
            ...
            <div>
              ...
              <input type="email" required value={email} onChange={e => setEmail(e.target.value)}
                ...
                placeholder="Ex: contato@hotelaplaceida.com.br" />
            </div>
            ...
            <div>
              ...
              <input type="text" required value={endereco} onChange={e => setEndereco(e.target.value)}
                ...
                placeholder="Ex: Rua das Flores, 123, Aparecida - SP" />
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Cidades Próximas (separadas por vírgula)</label>
            ...
            <div>
              ...
              <textarea value={descricao} onChange={e => setDescricao(e.target.value)}
                ...
                placeholder="Conte sobre as comodidades, localização especial perto da Basílica, etc..." />
            </div>
...
export default CadastroSucessoHotels;
