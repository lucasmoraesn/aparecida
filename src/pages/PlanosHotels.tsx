...
const PRICE_IDS: Record<string, string> = {
  basico: 'price_1TK30uJRpc53eVmKbuPx37LJ',
  destaque: 'price_1TK31vJRpc53eVmKK8Wlk35D',
  premium: 'price_1TK32IJRpc53eVmKZ5G4rC0X'
};
...
const PlanosHotels = () => {
  ...
  useEffect(() => {
    document.title = 'Planos para Hotéis | Explore Aparecida';
  }, []);
  ...
  const handleChoosePlan = async (plano: string) => {
    ...
    try {
      const response = await fetch(`${API_BASE}/api/create-hotels-subscription`, {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({ 
          ...
          cancelUrl: `${window.location.origin}/planos-hoteis`
        }),
      });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl mb-4">
            Cadastre seu Hotel em Aparecida
          </h1>
          <p className="text-xl text-gray-600">
            Aumente sua visibilidade e receba mais reservas de romeiros
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 flex flex-col items-center hover:shadow-md transition-shadow">
            ...
            <ul className="w-full space-y-4 mb-8 text-left">
              <li className="flex items-start gap-3 text-gray-600">
                ...
                <span>Nome do establishment</span>
              </li>
              <li className="flex items-start gap-3 text-gray-600">
                <Check className="w-5 h-5 text-green-500 shrink-0" />
              ...
              <li className="flex items-start gap-3 text-gray-600">
                <Check className="w-5 h-5 text-green-500 shrink-0" />
                <span>1 foto do establishment</span>
              </li>
            </ul>
          ...
          <div className="bg-white rounded-2xl shadow-xl border-2 border-blue-500 p-8 flex flex-col items-center relative transform md:-translate-y-4">
            ...
            <ul className="w-full space-y-4 mb-8 text-left">
              ...
              <li className="flex items-start gap-3 text-gray-600">
                <Check className="w-5 h-5 text-blue-500 shrink-0" />
                <span>Selo "Hotel Verificado"</span>
              </li>
              <li className="flex items-start gap-3 text-gray-600">
                <Check className="w-5 h-5 text-blue-500 shrink-0" />
