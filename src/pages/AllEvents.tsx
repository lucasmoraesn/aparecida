...
const allEvents = [
   ...
   {
      id: 10,
      name: "Exposição de Arte Sacra",
      description: "Exposição de obras de arte sacra e objetos religiosos históricos.",
      date: "Todo o Ano",
      time: "09:00h",
      location: "Museu Nossa Senhora Aparecida",
      type: "Cultural",
   ...
   {
      id: 11,
      name: "Concertos na Basílica",
      description: "Concertos de música sacra e coral na Basílica Nacional.",
   ...
   },
   {
      ...
      description: "Festival com pratos típicos da região e culinária local.",
      date: "Segunda Quinzena de Agosto",
      time: "18:00h",
      location: "Centro de Eventos",
      type: "Cultural",
      attendance: "3.000 pessoas",
         ...
         <div className="bg-white shadow-sm mt-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
               <div className="text-center mb-8">
                  <p className="text-gray-800 text-3xl font-bold max-w-4xl mx-auto leading-relaxed">
                     CONFIRA TODOS OS EVENTOS RELIGIOSOS E CULTURAIS DE APARECIDA DO NORTE
                  </p>
               </div>
            </div>
         </div>
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="mb-8">
               <div className="flex flex-wrap gap-4 justify-center">
                  <button className="bg-gray-800 text-white px-4 py-2 rounded-lg font-medium">
                     Todos
                  </button>
                  <button className="bg-gray-200 text-gray-800 px-4 py-2 rounded-lg font-medium hover:bg-gray-300">
                     Religiosos
                  </button>
                  <button className="bg-gray-200 text-gray-800 px-4 py-2 rounded-lg font-medium hover:bg-gray-300">
                     Culturais
